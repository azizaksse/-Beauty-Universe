...
import { createProduct } from "@/app/[locale]/admin/actions/products";
                        ...
                        <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            <div className="space-y-1">
                                <p className="text-sm font-medium text-gray-900">
                                    <label htmlFor="file-upload" className="cursor-pointer text-blue-600 hover:text-blue-700 hover:underline">
                                        Upload files
                                    </label>
                                    {" "}or drag and drop
                                </p>
